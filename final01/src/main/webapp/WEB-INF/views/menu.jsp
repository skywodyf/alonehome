...
<body>
	...
	<div class="nav">
	   ...
	   <c:otherwise>
	     <!-- 로그인한 상태 -->
	     <a href="#" class="nav-item nav-link"> ${sessionScope.user_name}님이 로그인 중입니다.</a>
	     <a href="${path}/member/view.do?user_email=${sessionScope.user_email}" class="nav-item nav-link">My Account</a> 
